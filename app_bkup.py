...
def create_venue_submission():
    ...
    try:
        ...
        venue = Venue(name=form_data['name'], city=form_data['city'], address=form_data['address'],
                      state=form_data['state'], phone=form_data['phone'], facebook_link=form_data['facebook_link'])
